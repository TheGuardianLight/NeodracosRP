            ...
            <form action="add-rp.php" method="post">
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="reseau_id" name="reseau_id" required aria-label="Sélectionner un réseau">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="type_id" name="type_id" required aria-label="Sélectionner le type de RP">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="oc1_id" name="oc1_id" required aria-label="Sélectionner le premier personnage">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="oc2_id" name="oc2_id" required aria-label="Sélectionner le second personnage">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="rp_roleplayer" name="rp_roleplayer" required aria-label="Sélectionner le roleplayer">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control" id="date_fin" name="date_fin" aria-describedby="dateFinHelp">
                        <div id="dateFinHelp" class="form-text">Format attendu : JJ/MM/AAAA</div>
                    </div>
                    <div class="col-md-6">
                        <label for="etat_id" class="form-label">État actuel</label>
                        <select class="form-select" id="etat_id" name="etat_id" required aria-label="Sélectionner l'état actuel">
                    ...
                    <?php foreach ($rps as $rp): ?>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div>
                                    État actuel : <span class="badge <?= getBadgeClass($rp['etat_name']) ?>"><?= htmlspecialchars($rp['etat_name']) ?></span>
                                </div>
                            </div>
                            <div>
                                ...
                                <form action="add-rp.php" method="post" class="d-inline">
                                    ...
                                    <button type="submit" name="delete_rp" class="btn btn-danger btn-sm" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce RP ?');">
                                        Supprimer
                                    </button>
                                </form>
                            </div>
